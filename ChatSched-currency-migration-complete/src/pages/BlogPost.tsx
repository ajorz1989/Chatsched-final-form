...
export default function BlogPost() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-5 py-16">
      ...
      <Link to="/blog" className="inline-flex items-center gap-1.5 font-mono text-xs font-semibold text-billboard-inkSoft hover:text-billboard-ink mb-6">← Back to blog</Link>
