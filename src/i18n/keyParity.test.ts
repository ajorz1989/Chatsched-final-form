 ...
 *
 * HowItWorks/ForBusinesses/ForPublishers dead stub namespaces were pruned
 * in Fix #4; active namespaces under full key parity verification are 'common' and 'home'.
 */
